...
public class CartOption extends RealmObject{
    ...
    String menu_option_price;
    String menu_option_category_name;

    public CartOption(){

    }

    public CartOption(int menu_option_id, String menu_option_name, String menu_option_price,String menu_option_category_name) {
