...
import com.example.fooddeuk.util.StatAcitivity
...
class PickMenuAdapter(val context: Context, private var menus: List<Menu>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup?, viewType: Int): RecyclerView.ViewHolder {
        ...
        menuViewHolder.itemView.setOnClickListener {
            context.StatAcitivity(RxBus.DetailMenuActivityData, menus[menuViewHolder.adapterPosition], DetailMenuActivity::class.java)
        }
