...
public interface HttpService {
  ...
  Completable updateToken(@Field("provider_id") String provider_id,
  ...
  @GET("api/review/readReviewByRestaurant")
  Single<ReviewResponse> getReviewByRestaurant(@Query("_id") String restaurant_id);
