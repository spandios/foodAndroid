...
public class MenuListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public interface OnItemClickListener {
        void onItemClick(RecyclerView.ViewHolder view, int menuItemHeight);
    }
    ...
    private View.OnClickListener menuExpandLayoutListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            TextView mMenuName=holder.itemView.findViewById(R.id.txt_menu_name);
            ImageView mMenuImage = holder.itemView.findViewById(R.id.menu_master_picture);
            LinearLayout mDetailLayout = holder.itemView.findViewById(R.id.menu_detail_layout);
            ...
            if(expandedPosition!=holder.getAdapterPosition()){
                ...
                onItemClickListener.onItemClick(holder,holder.itemView.findViewById(R.id.menu_master_layout).getHeight());
    ...
    private void setAnimation(TextView mMenuName, ImageView mMenuImage, boolean expand){
        if(expand){
            ...
            YoYo.with(Techniques.SlideOutDown)
                    .duration(400)
                    .onEnd(animator -> mMenuImage.setVisibility(View.GONE))
                    .playOn(mMenuImage);
        }else{
            ...
            YoYo.with(Techniques.SlideInUp)
                    .duration(400)
                    .onEnd(animator -> mMenuImage.setVisibility(View.VISIBLE))
                    .playOn(mMenuImage);
    ...
    private void setItemClick(RecyclerView.ViewHolder vh, String optionFLAG) {
        //EXPAND
