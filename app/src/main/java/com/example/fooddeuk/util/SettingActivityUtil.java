...
public class SettingActivityUtil {
    ...
    public static void settingGPS(Activity activity){
        new MaterialDialog.
                ...
                .positiveText("예")
                //GPS 설정창 이동
                .onPositive((dialog, which) -> activity.startActivityForResult(new Intent(Settings.ACTION_LOCATION_SOURCE_SETTINGS), StaticVal.INSTANCE.getGpsSettingActivityRequestCode()))
                .negativeText("아니요(종료)")
